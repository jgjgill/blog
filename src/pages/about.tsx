...
const values = [
  ...
  '개발자이지만 개발자에 의존하지 않은 환경을 만들고 싶습니다. 자동화를 통한 독립적인 환경, 사람이 아닌 문서에 의존하는 환경을 만들고자 합니다.',
  '실패에 크게 연연하지 않습니다. 실패를 겪으면 원인을 찾아 다시 경험하지 않는 것에 집중합니다.',
  '`1일 1배포`를 실천합니다. 작은 성취와 빠른 피드백을 통한 지속적인 개선을 추구합니다.',
