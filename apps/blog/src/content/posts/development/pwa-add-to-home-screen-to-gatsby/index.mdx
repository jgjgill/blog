...
![desktop-a2hs](./images/desktop-a2hs.gif)
</div>

<div style={{width: '50%'}}>
**모바일**

![mobile-a2hs](./images/mobile-a2hs.gif)
</div>
</div>
...
![beforeinstallpromptevent](./images/beforeinstallpromptevent.gif)
