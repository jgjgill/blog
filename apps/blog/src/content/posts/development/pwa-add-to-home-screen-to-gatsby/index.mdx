...
![application-manifest](./images/application-manifest.png)
...
![desktop-a2hs](/images/posts/pwa-add-to-home-screen-to-gatsby/desktop-a2hs.gif)
</div>

<div style={{width: '50%'}}>
**모바일**

![mobile-a2hs](/images/posts/pwa-add-to-home-screen-to-gatsby/mobile-a2hs.gif)
</div>
</div>
...
![beforeinstallpromptevent](/images/posts/pwa-add-to-home-screen-to-gatsby/beforeinstallpromptevent.gif)
...
![a2hs](/images/posts/pwa-add-to-home-screen-to-gatsby/a2hs.gif)
