...
![예제 코드 결과](./images/example-code-result.png)
...
![예제 JSX 결과](./images/example-jsx-result.png)
...
![예제 함수 결과](./images/example-function-result.png)
...
![예제 함수 문제점](./images/example-function-problem.png)
...
![렌더링하지 않은 예제 JSX 트리](./images/example-jsx-tree-not-render.png)
...
![렌더링한 예제 JSX 트리](./images/example-jsx-tree-render.png)
...
![예제 함수 트리](./images/example-function-tree.png)
...
<video src="/videos/development/how-do-you-call-component/exmaple-function-array-result.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />
