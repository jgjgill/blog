...
![chromatic](./images/chromatic.png)
...
![chromatic-project-token](./images/chromatic-project-token.png)

그러면 다음과 같이 PR에서 스토리북 배포 링크 코멘트가 추가되는 것을 확인할 수 있다.

![storybook-pr](./images/storybook-pr.png)
...
![storybook-deploy](./images/storybook-deploy.png)
...
![vercel-id](./images/vercel-id.png)
...
![vercel-token](./images/vercel-token.png)
...
![deploy-pr](./images/deploy-pr.png)
