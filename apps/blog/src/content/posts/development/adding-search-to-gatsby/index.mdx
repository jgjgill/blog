...
![graphql-allfusejs-data](./images/graphql-allfusejs-data.png)

index에는 앞서 keys에 넣었던 데이터들이 검색으로 활용될 수 있도록 변형된 것을 확인할 수 있습니다.

![graphql-allfusejs-index](./images/graphql-allfusejs-index.png)
...
![search](/images/posts/adding-search-to-gatsby/search.gif)
