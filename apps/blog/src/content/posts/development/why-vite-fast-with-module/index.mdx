...
![copy-and-paste-1](./images/copy-and-paste-1.png)

각각의 스크립트 파일은 다음과 같이 구성되어 있다.

![copy-and-paste-2](./images/copy-and-paste-2.png)
...
![copy-and-paste-3](./images/copy-and-paste-3.png)
...
![IIFE-1](./images/IIFE-1.png)

각각의 스크립트는 다음과 같이 구성된다.

![IIFE-2](./images/IIFE-2.png)

`App` 파일에서는 객체를 선언한다.

![IIFE-3](./images/IIFE-3.png)

`users` 파일에서는 앞서 선언한 APP 객체에 데이터를 추가한다.

<div style={{ display: 'flex', justifyContent: 'center', gap: '10px' }}>
  ![IIFE-4](./images/IIFE-4.png)
  ![IIFE-5](./images/IIFE-5.png)
</div>
...
![commonJS-1](./images/commonJS-1.png)

<div style={{ display: 'flex', justifyContent: 'center', gap: '10px' }}>
  ![commonJS-2](./images/commonJS-2.png)
  ![commonJS-3](./images/commonJS-3.png)
</div>

![commonJS-4](./images/commonJS-4.png)

![commonJS-5](./images/commonJS-5.png)
...
![ES-Modules-1](./images/ES-Modules-1.png)

<div style={{ display: 'flex', justifyContent: 'center', gap: '10px' }}>
  ![ES-Modules-2](./images/ES-Modules-2.png)
  ![ES-Modules-3](./images/ES-Modules-3.png)
</div>

![ES-Modules-4](./images/ES-Modules-4.png)

![ES-Modules-5](./images/ES-Modules-5.png)
...
![ES-Modules-6](./images/ES-Modules-6.png)
