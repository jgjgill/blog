---
title: '접근성 트리에 대해 알아보기'
description: '접근성 트리에 대해 정리합니다.'
date: '2023-05-24'
thumbnail: './images/accessibility-tree-thumbnail.png'
thumbnail_alt: 'accessibility-tree-thumbnail'
category: 'development'
---

<Callout>💡 접근성 트리에 대해 정리합니다. 피드백은 언제나 환영입니다:)</Callout>
...
![screen-reader-dom-api-mockup](./images/screen-reader-dom-api-mockup.png)

접근성 트리로 구성된 페이지는 대략 다음과 같이 오래된 웹 페이지와 같은 형태가 된다.

![1990s-style-web-page](./images/1990s-style-web-page.png)
...
![chrome-accessibility-tree](/images/posts/learn-about-accessibility-tree/chrome-accessibility-tree.gif)
