...
<video src="/videos/development/tadd-test-ai-driven-development-taking-control-of-ai/as-is-default.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />
...
<video src="/videos/development/tadd-test-ai-driven-development-taking-control-of-ai/as-is-problem.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />
...
![TADD 실패 테스트](./images/tadd-fail-test.png)
...
![TADD 성공 테스트](./images/tadd-success-test.png)

<br />

<video src="/videos/development/tadd-test-ai-driven-development-taking-control-of-ai/to-be-success.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />
