...
![새 프로젝트 생성](./images/new-project-create.png)

<br />

프로젝트에 **Sheets API**를 사용하기 위해 API를 검색해서 적용할 수 있도록 한다.

![시트 API 사용](./images/sheet-api-use.png)
...
![서비스 계정 생성 과정 1](./images/service-account-create-process-1.png)

<br />

**이름, 계정 ID, 설명**을 입력해서 계정을 생성한다.

![서비스 계정 생성 과정 2](./images/service-account-create-process-2.png)

<br />

다음과 같이 생성된다.

![서비스 계정 생성 과정 3](./images/service-account-create-process-3.png)
...
![API 키 생성 과정 1](./images/api-key-create-process-1.png)

<br />

다음과 같이 바로 생성이 된다.

![API 키 생성 과정 2](./images/api-key-create-process-2.png)
...
![API 키 생성 과정 3](./images/api-key-create-process-3.png)
...
![스프레드시트 설정 과정 1](./images/spreadsheet-setting-process-1.png)
...
![스프레드시트 설정 과정 2](./images/spreadsheet-setting-process-2.png)
...
![구글 시트 접근자 정보 구성 과정 1](./images/google-sheet-accessor-information-configuration-process-1.png)

<br />

`JSON` 유형으로 생성한다.

![구글 시트 접근자 정보 구성 과정 2](./images/google-sheet-accessor-information-configuration-process-2.png)
...
![시트 추가 예제](./images/add-sheet-exmaple.png)
...
![시트 삭제 예제](/images/posts/google-spreadsheet-with-javascript/delete-sheet-example.gif)
...
![HeaderRow 추가 예제](./images/set-header-row-example.png)
...
![Row 추가 예제](./images/add-row-example.png)
...
![Cell 기능 예제](./images/cell-example.png)
