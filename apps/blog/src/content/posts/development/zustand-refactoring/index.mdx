...
![hello test1 예제](./images/hello-test1.png)
...
![initializeStore 타입 에러](./images/initialize-store-type-error.png)

<br />

![useTest1 타입 에러](./images/useTest1-type-error.png)
...
![프로젝트에서 쓰이는 Zustand 구조도](./images/project-zustand-structure.png)
...
![서버에서 스토어 액션 사용할 때 발생하는 에러](./images/server-store-action-error.png)
...
![useTest1 타입 개선](./images/useTest1-type-refactor.png)
