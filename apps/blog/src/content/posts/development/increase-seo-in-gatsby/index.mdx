...
![github-og-icon-path](./images/github-og-icon-path.png)
...
![og-test-link](./images/og-test-link.png)

생성된 링크를 소셜 미디어 플랫폼에서 확인하면 끝입니다.

![og-test-result](./images/og-test-result.png)
...
![seo-component-result-in-page](./images/seo-component-result-in-page.png)
...
![sitemap-result](./images/sitemap-result.png)
...
![rss-result](./images/rss-result.png)
...
![robots-result](./images/robots-result.png)
