...
![graphql-mdx-category](./images/graphql-mdx-category.png)

특정 mdx 파일뿐만 아니라 전체 mdx 파일에서도 해당하는 카테고리에 대한 데이터를 받아올 수 있습니다.

![graphql-allmdx-category](./images/graphql-allmdx-category.png)
...
![graphql-category-count](./images/graphql-category-count.png)
...
![category](/images/posts/adding-category-to-gatsby/category.gif)
