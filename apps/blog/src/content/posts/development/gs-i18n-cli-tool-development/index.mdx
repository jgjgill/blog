...
> [gs-i18n](https://jgjgill.github.io/gs-i18n/) 많은 관심 부탁드립니다.. 🙇‍♂️
...
![다국어 프로세스 비교](./images/multilingual-comparison.png)
...
![멀티패러다임 프로그래밍](./images/multi-paradigm-programming-thumbnail.png)
...
<video src="/videos/development/gs-i18n-cli-tool-development/gs-i18n-1.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />

### i18next-scanner 파일 생성하기

<video src="/videos/development/gs-i18n-cli-tool-development/gs-i18n-2.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />

### 다국어 관련 기본 파일 구성하기

<video src="/videos/development/gs-i18n-cli-tool-development/gs-i18n-3.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />

### 다국어 코드 시트에 반영하기

<video src="/videos/development/gs-i18n-cli-tool-development/gs-i18n-4.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />

### 시트 번역 내용 코드에 반영하기

<video src="/videos/development/gs-i18n-cli-tool-development/gs-i18n-5.mp4" controls style="max-width:100%;max-height:400px;display:block;margin:1.5rem auto;border-radius:0.5rem;" />
