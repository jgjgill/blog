...
![JSON.stringify() Error 콘솔](../../images/stringify-error-console.png)
...
![getOwnPropertyDescriptors 예제](../../images/get-own-property-descriptors-example.png)
...
![JSON.stringify() 정상 출력](../../images/stringify-success.png)
