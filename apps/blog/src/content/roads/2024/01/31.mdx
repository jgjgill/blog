...
![console.log 결과](../../images/console-log-result.png)
...
![console.log 결과](../../images/json-stringify-console-log-result.png)
...
![JSON.stringify 화면 결과](../../images/json-stringify-screen-result.png)

### whiteSpace 이해하기

스타일을 추가하자.

![whiteSpace 테이블](../../images/white-space-table.png)
...
![whiteSpace 화면 결과](../../images/white-space-screen-result.png)
