...
![TypeScript 지시어 주석](../../images/typescript-directive-annotation.png)
...
![// @ts-check 에러 예제](../../images/ts-check-error.png)
...
![타입 에러 코드](../../images/type-error-code.png)

타입 에러가 발생하는 예제 코드이다.

![// @ts-nocheck 사용 예제](../../images/ts-nocheck-code.png)
...
![// @ts-ignore 사용 예제](../../images/ts-ignore-code.png)
...
![// @ts-expect-error 사용 예제](../../images/ts-expect-error-code.png)
...
![// Unused @ts-expect-error 사용 예제](../../images/unused-ts-expect-error-code.png)
