...
![커링 리팩터링 과정 1](../../images/currying-first-code.png)
...
![커링 리팩터링 과정 2-1](../../images/currying-second-code-1.png)

![커링 리팩터링 과정 2-2](../../images/currying-second-code-2.png)
...
![커링 간단한 버전](../../images/currying-simple-version.png)

커링을 활용해서 리팩터링을 해보자.

![커링 리팩터링 과정 3-1](../../images/currying-third-code-1.png)

![커링 리팩터링 과정 3-2](../../images/currying-third-code-2.png)
...
![커링 리팩터링 최종 코드](../../images/currying-last-code.png)
